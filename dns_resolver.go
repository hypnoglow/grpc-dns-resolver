...
// RegisterDefault registers dns resolver with default settings.
func RegisterDefault() {
	resolver.Register(&dnsBuilder{freq: defaultFreq})
}

// RegisterWithFreq registers dns resolver with specific frequency of polling
// the DNS server.
func RegisterWithFreq(freq time.Duration) {
	resolver.Register(&dnsBuilder{freq: freq})
}
